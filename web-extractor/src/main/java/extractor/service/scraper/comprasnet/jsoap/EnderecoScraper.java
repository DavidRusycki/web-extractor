...
public class EnderecoScraper extends Scraper{
	...
	public void scrap() {
		...
		String result = elements.first().childNodes().get(0).childNode(10).toString();		
		
		dto.setEndereco(removeNonBreakingSpace(result));
	}
